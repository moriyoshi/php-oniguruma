--TEST--
Test onig_ereg() function : usage variations - different regex features in $pattern
--SKIPIF--
<?php
...
var_dump(onig_ereg($regex_ascii, $string_ascii, $regs_ascii));
...
var_dump(onig_ereg($regex_mb, $string_mb, $regs_mb));
