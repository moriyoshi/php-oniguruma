--TEST--
Test onig_ereg() function : usage variations - match special characters
--SKIPIF--
<?php
...
/*
 * Test how onig_ereg() matches special characters for $pattern
 */
...
foreach ($regex_char as $displayChar => $char) {
	...
	echo "-- ASCII String: --\n";
	var_dump(onig_ereg($char, $string_ascii, $regs_ascii));
	base64_encode_var_dump($regs_ascii);

	echo "-- Multibyte String: --\n";
	var_dump(onig_ereg($char, $string_mb, $regs_mb));
