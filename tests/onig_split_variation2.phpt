--TEST--
Test onig_split() function : usage variations  - different parameter types for string
--SKIPIF--
<?php
...
foreach($inputs as $input) {
      echo "\n-- Iteration $iterator --\n";
      var_dump( onig_split($pattern, $input, $limit) );
      $iterator++;
};
...
Warning: onig_split() expects parameter 2 to be string, resource given in %s on line %d
NULL
Done
