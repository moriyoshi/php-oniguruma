--TEST--
Test onig_ereg_replace() function : usage variations
--SKIPIF--
<?php
...
echo "*** Testing onig_ereg_replace() : usage variations ***\n";
...
foreach($inputs as $input) {
      echo "\n-- Iteration $iterator --\n";
      var_dump( onig_ereg_replace($pattern, $replacement, $input, $option) );
      $iterator++;
};
...
?>
--EXPECTF--
*** Testing onig_ereg_replace() : usage variations ***
...
Warning: onig_ereg_replace() expects parameter 3 to be string, resource given in %s on line %d
NULL
Done
